    ...
    <body>
        ...
        <?php
            ...
            try{
                ...
                //eliminar una pareja.
                $query = "MATCH (n) WHERE n.idPareja='".$idPareja."' DETACH DELETE n";
                ...
                echo "</div>";
                echo "<p id='tInsertado'>"; echo "PAREJA CON ID '". $idPareja ."' ELIMINADA CORRECTAMENTE"; echo "</p>";
                echo "</br>";
